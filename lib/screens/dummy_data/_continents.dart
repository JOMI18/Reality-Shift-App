...
class _Continents extends StatefulWidget {
  const _Continents({super.key});

  @override
  State<_Continents> createState() => __ContinentsState();
}

class __ContinentsState extends State<_Continents> {
  List continents = [
    {
      "title": "Africa",
      ...
      "countries": [
        {"country": "Nigeria", "flag": "nigeria.png"},
        {"country": "Egypt", "flag": "egypt.png"}
      ]
    },
    {
      "title": "South America",
