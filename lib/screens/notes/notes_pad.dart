...
class NotesPad extends StatefulWidget {
  bool? isNoteBeingCreated;
  final VoidCallback? onBackArrowPressed;
  NotesPad({super.key, this.isNoteBeingCreated, this.onBackArrowPressed});
  ...
  void popBottomSheetUp(noteData, id, primary) {
    final content = Padding(
      ...
      child: Column(
        ...
        children: [
          CustomTextField.input(context, controller: titleCt, fieldname: "Name of Note"),
          SizedBox(height: 2.h),
          CustomTextField.dialogBox(context, controller: bodyCt, fieldname: "What I need to remember"),
          SizedBox(height: 2.h),
          Row(
              ...
              Btns().shortBtn(
                  ...
                  isCreateActionActive
                      ...
                      : () {
                          ...
                          setState(() {
                            final currNote = Note(id: id, title: titleCt.text, text: bodyCt.text, dateCreated: "");
                            noteData.updateNote(currNote, currNote.title, currNote.text);
                            titleCt.clear();
                            bodyCt.clear();
    ...
    return CustomBottomSheet.showContent(context, content, 65.h, color: primary);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer(
      builder: (context, ref, _) {
        ...
        Color colorbgWhite = selectedTheme == darkTheme ? Colors.teal.withOpacity(0.6) : secondary.withOpacity(0.6);
                ...
                children: [
                  ComponentSlideIns(
                    ...
                    child: Column(
                      ...
                      children: [
                        GestureDetector(
                          onTap: widget.onBackArrowPressed,

                          // onTap: () {
                          //   // print(widget.isNoteBeingCreated);
                          //   setState(() {
                          //     // widget.isNoteBeingCreated = false;
                          //     // print(widget.isNoteBeingCreated);
                          //   });
                        ...
                        Row(
                          ...
                          children: [
                            Flexible(
                              child: Text("Inside Quick Notes".toUpperCase(),
                                  softWrap: true,
                            ...
                            Icon(Icons.auto_awesome_motion_sharp, color: secondary, size: 25)
                          ],
                        ),
                        Padding(
                          padding: EdgeInsets.fromLTRB(12.w, 8, 0, 4.h),
                          child: Divider(height: 2, thickness: 4, color: secondary),
                        ),
                      ],
                    ),
                  ),
                  Column(
                      children: List.generate(note.getAllNotes().length, (index) {
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        setState(() {
                                          expandedNoteIndex = isExpanded ? null : index;
                                        });
                                      },
                                      child: Icon(
